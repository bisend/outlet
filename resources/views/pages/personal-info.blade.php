                    ...
                    <div class="profile-nav">
                        <ul>
                            <li><a href="javascript:void(0);"
                                   style="color: #000;">{{ trans('profile.personal_info') }}</a></li>
                            <li>
                                <a href="{{ url_payment_delivery($model->language) }}">{{ trans('profile.payment_delivery') }}</a>
                            </li>
                            <li><a href="{{ url_wish_list($model->language) }}">{{ trans('profile.wish_list') }}</a>
                            </li>
                            <li><a href="{{ url_my_orders($model->language) }}">{{ trans('profile.my_orders') }}</a>
                            </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="input-group-default">
                                            ...
                                            <input type="text" class="input-default" id="comment-name"
                    ...
                    <div class="profile-item">
                        <div class="profile-item-header">
                            <span><i class="fa fa-user"
                                     aria-hidden="true"></i></span>{{ trans('profile.personal_info') }}
                        </div>
                    ...
                    <div class="profile-item">
                        <div class="profile-item-header">
                            <span><i class="fa fa-unlock-alt"
                                     aria-hidden="true"></i></span>{{ trans('profile.change_password') }}
                        </div>
