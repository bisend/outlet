...
@section('content')
    ...
    <div class="breadcrumb-default">
        <div class="container">
            <h1>{{ trans('home.novelty') }} <span>{{ $model->countProducts }}</span></h1>
            <ol class="breadcrumb">
                            ...
                            <ul class="pagination">
                                ...
                                @if($isPrev)
                                    <li class="page-item">
                                        <a class="page-link previous"
                                           href="{{ url_novelty_per_page($model->sort, $model->page - 1, $model->language) }}"
                                           aria-label="Previous">
                                ...
                                @foreach($pages as $page)
                                    ...
                                    @else
                                        ...
                                        @else
                                            <li class="page-item">
                                                <a href="{{ url_novelty_per_page($model->sort, $page, $model->language) }}"
                                                   class="page-link">
                                                    {{ $page }}
                                                </a>
                                            </li>
